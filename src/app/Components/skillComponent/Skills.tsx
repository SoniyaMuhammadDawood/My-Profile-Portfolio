...
let PixelCanvasElement: CustomElementConstructor

if (typeof window !== "undefined") {
  class _PixelCanvasElement extends HTMLElement {
  ...
  PixelCanvasElement = _PixelCanvasElement
...
const PixelCanvas = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
  ({ gap, speed, colors, variant, noFocus, style, ...props }, ref) => {
    React.useEffect(() => {
      // Element is already defined above if on client
    }, [])
